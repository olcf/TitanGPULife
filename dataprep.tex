...
The location references are cabinet row (0-24), column (0-7), cage
...
\fix{The logical 3d torus layout is $25\times 16\times 24$. How does
  the 16 dimension map onto this? Are the 4 nodes actually very far
  apart in terms of the network layout?}
