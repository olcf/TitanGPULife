...
life times. \rev{A detailed followup of a few of these overlaps found
  that they are caused by incomplete inventories, where for a moved
  GPU a node query of times out, creating the appearance that a unit
  is in two locations.}
...
views of \rev{90} randomly selected GPUs and \rev{90} randomly
selected locations \rev{in Fig.~\ref{fig:gpu-view}}.  The GPU view
