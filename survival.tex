...
\begin{figure}
  ...
  \caption{\rev{GPU hazard ratios from Cox regression model on {\em
        old} batch, with the {\em col} variable in logical
      X-coordinate torus order. The torus order removes the peculiar
      interleaving pattern in Fig.~\ref{fig:cox-old} and presents a
      response that can be explained by a combination of system
