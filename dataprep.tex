...
(DBE) and Off the Bus (OTB). \rev{While other types of errors were
  recorded in log files, as is reported in \cite{7266836}, these two
  kinds of errors became dominant in 2016 and were found to be the
...
recorded in a separate file. \rev{An inventory can be incomplete if a
  node response times out but such occurrences were relatively rare}.
...
2014-2015 time frame. \rev{However, by the time the weekly inventories
  were added, failure rates started to increase and lead to more
  frequent reboots and thus inventories.}
