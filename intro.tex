...
many technological boundaries. \rev{This early period included
  extensive field engineering and experimentation to determine cause,
  down times, and large temporal and completeness gaps in inventory
  runs. We include the early swap data in this figure only for
  completeness and to underscore the amount of work required to field
  a world's largest supercomputer. However, we exclude this period
  from further analysis because we have a gap in explanation for one
  of the swap spikes and because the separation is made possible by
  the second, late 2013, GPU rework cycle.} Late 2013 begins a very
...
board (not the GPU chip iself) \fix{Was anything published about this?
  If not, we may use \cite{Vargas2009TheCO}}. Throughout this paper,
