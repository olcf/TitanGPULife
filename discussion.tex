...
\rev{The failure rates of the old batch are not matched by the new
  ...
  failing resistors made the specific GPU batch act as a sensitive
  instrument for obtaining long-term integrals of component heat
  dynamics and provided lessons learned. Here we dicsuss the
