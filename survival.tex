...
and 3 having lower failure rates than nodes 0 and 1. \rev{An
  increasing temperature gradient averaging about $4^\circ$C per
  cage is reported in \cite[p.7]{tiwari15Understand}, independently
  confirming our airflow temperature interpretation.}
