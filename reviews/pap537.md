...
- What conclusions should one draw from the inter-inventory time shown
  ...
  * *George: had event dates mixed in before. Now without shows 56
    day gap and reason for weekly inventory.* 
...
- Your data shows a clear correlation between reliability and
  ...
  * *Anyone? I had a conversation with Scott Atchley*
...
- Section 6: how was the conclusion that GPU lifetimes were
  ...
  logs)?
  * *George: Improved Figure 4. Don: Are there other data? Airflow
    from Jaguar. Copyright?*
- It would be helpful to correlate lifetime data against any
  ...
  * *We taled about direction of scheduling. Should we mention it?*
